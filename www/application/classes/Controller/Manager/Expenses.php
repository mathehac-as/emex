...
class Controller_Manager_Expenses extends Controller_Template {
            
    public $template = 'manager/VPanelCenterExpensesExpenses';

    public function action_get_expenses()
    {
        $expenses = Model::factory('Manager_Expenses');
    ...
    { 
        ...
        try
        {
            if($post = $this->request->post())
            {
                ...
                $officehistory = Model::factory('Manager_Officehistory'); 
                $data = array();
                $data['sum'] = $sum;
